...
export const metadata: Metadata = {
  title: 'Slapukų politika / Cookie Policy / Політика файлів cookie',
};
  ...
  return (
    <div className="max-w-3xl mx-auto py-8 space-y-8">
      <div className="text-center">
        ...
        <p className="text-gray-600 mt-2">Cookie Policy / Політика файлів cookie</p>
      </div>

      <div className="prose max-w-none">
        <h2>Kas yra slapukai? / What are cookies?</h2>
        <p>
        ...
        <h2>Naudojami slapukai / Cookies Used</h2>
        
        <div className="space-y-4 not-prose">
          <div className="p-4 border rounded-lg">
            <h3 className="font-bold text-lg">Būtini slapukai / Necessary</h3>
          ...
          <div className="p-4 border rounded-lg">
            <h3 className="font-bold text-lg">Analitiniai slapukai / Analytics</h3>
            <p className="text-sm text-gray-600">
          ...
          <div className="p-4 border rounded-lg">
            <h3 className="font-bold text-lg">Rinkodaros slapukai / Marketing</h3>
            <p className="text-sm text-gray-600">
