    ...
    <div className="space-y-12">
      ...
      <section className="text-center py-12 bg-gradient-to-b from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 rounded-xl">
        ...
        <div className="mt-6 flex justify-center gap-4">
          ...
          <a href="/heritage" className="px-6 py-3 border border-primary text-primary rounded-lg hover:bg-primary hover:text-white transition-colors">Paveldas / Heritage</a>
        </div>
      </section>

      {/* Mass Schedule */}
      <section>
        <h2 className="text-2xl font-heading font-semibold mb-6">Mišių tvarkaraštis</h2>
        <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6">
          <p className="text-gray-600 dark:text-gray-400">Mass schedule coming soon...</p>
        </div>
      </section>
