...
export const metadata: Metadata = {
  ...
  description: `${entityConfig.name.lt} - ${entityConfig.canonical.jurisdiction}. Mass schedules, sacraments, and parish life.`,
  keywords: ['parapija', 'parish', 'Vilnius', 'Lithuania', 'Catholic', 'Church', 'Šv. Jonas'],
        ...
        <footer className="bg-gray-800 text-white py-8">
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-3 gap-8">
              ...
              {/* Office Hours */}
              <div>
                <h3 className="font-heading text-lg mb-4">Biuro darbo laikas / Office Hours</h3>
                <ul className="space-y-2 text-sm text-gray-300">
                  <li>Darbo dienomis: {entityConfig.contact.officeHours.weekdays}</li>
                  <li>Savaitgaliais: {entityConfig.contact.officeHours.weekends}</li>
                </ul>
              </div>
