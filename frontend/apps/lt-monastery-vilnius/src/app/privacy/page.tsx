    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="prose prose-lg">
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>Telefono numeris (neprivaloma)</li>
          <li>Apsilankymo istorija</li>
          <li>Sutikimo įrašai</li>
        </ul>

        <h2 className="text-xl font-heading text-primary mt-6 mb-3">3. Duomenų tvarkymo tikslai / Processing Purposes</h2>
        <ul className="list-disc pl-6 mb-4">
          <li>Vienuolyno bendruomenės aptarnavimas</li>
          <li>Rekolekcijų organizavimas</li>
          <li>Svečių namų rezervacijos</li>
          <li>Žemės ūkio ir amatų veikla</li>
        </ul>
        ...
        <h2 className="text-xl font-heading text-primary mt-6 mb-3">6. Specialiųjų kategorijų duomenys</h2>
        <p className="text-gray-700 mb-4">
          Vienuolynas kaupia religinio pobūdžio duomenis (BDAR 9 str.), kurie reikalingi kanoninėms įsipareigojimams vykdyti.
        </p>

        <h2 className="text-xl font-heading text-primary mt-6 mb-3">7. Kontaktai / Contact</h2>
