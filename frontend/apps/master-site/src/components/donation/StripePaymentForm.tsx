...
import type { StripeCardElementChangeEvent, StripeError } from '@stripe/stripe-js';
...
export function StripePaymentForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Construct a synthetic StripeError for unexpected errors
      const syntheticError: StripeError = {
        type: 'api_error' as const,
        message: 'An unexpected error occurred. Please try again.',
      };
      
      setCardError(syntheticError.message || 'An unexpected error occurred');
