      ...
      <div className="prose prose-lg">
        ...
        <div className="space-y-4">
          <div className="p-4 border rounded">
            ...
            <p className="text-sm text-gray-600">Sutikimas gauti koplyčios naujienas</p>
          </div>
          ...
          <div className="p-4 border rounded">
            <h3 className="font-medium">Piligrimystė / Pilgrimage</h3>
            <p className="text-sm text-gray-600">Sutikimas piligrimystės registracijai</p>
          </div>
          
          <div className="p-4 border rounded">
            <h3 className="font-medium">Žvakės / Candles</h3>
            <p className="text-sm text-gray-600">Sutikimas žvakių intencijoms</p>
          </div>
        </div>
