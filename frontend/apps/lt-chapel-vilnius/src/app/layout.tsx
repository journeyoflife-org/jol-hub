...
export const metadata: Metadata = {
  ...
  description: `${entityConfig.name.lt} - Pilgrimage shrine. Gate of Dawn, Vilnius. Open daily for prayer and confession.`,
  keywords: ['koplyčia', 'chapel', 'Aušros Vartai', 'Vilnius', 'Lithuania', 'Catholic', 'pilgrimage', 'shrine'],
  ...
  openGraph: {
    ...
    type: 'website',
    locale: 'lt_LT',
    alternateLocale: ['en_GB', 'pl_PL', 'ru_RU'],
  },
};
          ...
          <div className="container mx-auto px-4">
            <div className="py-4 flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-liturgical-gold">Piligrimystės vieta / Pilgrimage Shrine</p>
              </div>
        ...
        <footer className="bg-gray-800 text-white py-8">
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-3 gap-8">
              ...
              {/* Visiting Hours */}
              <div>
                <h3 className="font-heading text-lg mb-4">Apsilankymas / Visiting</h3>
                <ul className="space-y-2 text-sm text-gray-300">
                  <li>Darbo dienomis: {entityConfig.visitingHours.weekdays}</li>
                  <li>Savaitgaliais: {entityConfig.visitingHours.weekends}</li>
                  <li>Šventėmis: {entityConfig.visitingHours.holidays}</li>
                </ul>
              </div>
