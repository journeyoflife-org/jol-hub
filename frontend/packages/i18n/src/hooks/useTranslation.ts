/**
 * useTranslation — Public API barrel
 *
 * Exports:
 ...
 *   - LITURGICAL_TERMS        (hardcoded liturgical dictionary)
 *   - getLiturgicalTerm       (dictionary lookup with lt fallback)
 *   - isLiturgicalTerm        (predicate for guard checks)
 *
...
// ---------------------------------------------------------------------------
// Types (client-safe, no deepl-node imports)
// ---------------------------------------------------------------------------
