...
export const CONSENT_TEXTS: Record<string, ConsentTexts> = {
  lt: {
    ...
    description:
      'Mes naudojame slapukus, kad užtikrintume tinkamą svetainės veikimą ir pagerintume Jūsų naršymo patirtį. Pasirinkite slapukų kategorijas, kurioms sutinkate.',
    ...
    categories: {
      necessary: {
        name: 'Būtinieji',
        description: 'Reikalingi svetainės veikimui. Negali būti išjungti.',
      },
      analytics: {
        name: 'Analitiniai',
        description: 'Padeda mums suprasti, kaip naudojate svetainę.',
      },
      marketing: { name: 'Rinkodaros', description: 'Naudojami reklamos ir marketingo tikslais.' },
      functional: {
        name: 'Funkciniai',
        description: 'Užtikrina papildomas funkcijas, pvz., kalbos pasirinkimą.',
      },
    },
  },
  en: {
    ...
    description:
      'We use cookies to ensure proper website functionality and improve your browsing experience. Select the cookie categories you consent to.',
    ...
    categories: {
      ...
      functional: {
        name: 'Functional',
        description: 'Enable additional features like language preference.',
      },
    },
  },
  pl: {
    ...
    description:
      'Używamy plików cookie, aby zapewnić prawidłowe działanie strony i poprawić komfort przeglądania. Wybierz kategorie plików cookie, na które wyrażasz zgodę.',
    ...
    categories: {
      necessary: {
        name: 'Niezbędne',
        description: 'Wymagane do działania strony. Nie można wyłączyć.',
      },
      analytics: {
        name: 'Analityczne',
      ...
      marketing: {
        name: 'Marketingowe',
        description: 'Używane do celów reklamowych i marketingowych.',
      },
      functional: {
        name: 'Funkcjonalne',
        description: 'Umożliwiają dodatkowe funkcje, np. wybór języka.',
      },
    },
  },
  ru: {
    ...
    description:
      'Мы используем файлы cookie для обеспечения надлежащей работы сайта и улучшения вашего опыта просмотра. Выберите категории файлов cookie, на которые вы соглашаетесь.',
    ...
    categories: {
      ...
      functional: {
        name: 'Функциональные',
        description: 'Обеспечивают дополнительные функции, например, выбор языка.',
      },
    },
  },
};
...
export const FALLBACK_CONSENT_TEXTS: ConsentTexts = {
  title: 'Cookie Consent',
  description:
    'We use cookies to ensure proper website functionality and improve your browsing experience.',
  acceptAll: 'Accept All',
  acceptNecessary: 'Necessary Only',
  settings: 'Settings',
  save: 'Save Preferences',
