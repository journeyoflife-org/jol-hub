...
| O-013 | DPIA for public-facing AI (MASTER-PROMPT §13 trigger) — launch-blocking · **PAYMENT-EVENTS FLOW DPIA DRAFTED 2026-08-27**: `docs/compliance/dpia-payment-events.md` (recommendation CONDITIONAL-GO, conditions C1–C4; verdict entry comes ONLY after owner decision — separate task) | Platform owner | OPEN (payment-flow DPIA drafted; AI-facing DPIA untouched) |
