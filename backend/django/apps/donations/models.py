...
class Donation(BaseModel):
    ...
    payment_method = models.CharField(
        _("payment method"), max_length=20, choices=METHOD_CHOICES
    )
    transaction_id = models.CharField(
        _("transaction ID"), max_length=255, blank=True, db_index=True
    )
    ...
    recurring_plan_id = models.CharField(
        _("recurring plan ID"), max_length=255, blank=True
    )
