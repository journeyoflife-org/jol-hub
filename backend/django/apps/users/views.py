    ...
    def get(self, request):
        ...
        data_inventory = {
            ...
            "consent_status": {
                ...
                "gdpr_consent_at": (
                    user.gdpr_consent_at.isoformat() if user.gdpr_consent_at else None
                ),
...
class GDPRDataExportView(APIView):
    ...
    def get(self, request):
        ...
        if (
            "error" in dsar_result
            and dsar_result.get("status") == "service_unavailable"
        ):
...
class GDPRDataDeleteView(APIView):
    ...
    def delete(self, request):
        ...
        dsar_result = integration.handle_data_erasure_request(
            str(user_id), dry_run=False
        )
