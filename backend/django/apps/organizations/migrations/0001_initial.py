        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "domain",
                    models.CharField(
                        blank=True, max_length=255, unique=True, verbose_name="domain"
                    ),
                ),
                (
                    "theme",
                    models.CharField(
                        default="default", max_length=64, verbose_name="theme"
                    ),
                ),
                (
                    "default_language",
                    models.CharField(
                        default="en", max_length=8, verbose_name="default language"
                    ),
                ),
                ("languages", models.JSONField(default=list, verbose_name="languages")),
                (
                    "ssl_enabled",
                    models.BooleanField(default=True, verbose_name="SSL enabled"),
                ),
                (
                    "analytics_id",
                    models.CharField(
                        blank=True, max_length=64, verbose_name="analytics ID"
                    ),
                ),
