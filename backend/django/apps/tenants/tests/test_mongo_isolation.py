...
class TestMongoStoreIsolation:
    ...
    def test_tenant_id_propagates_to_mongo_queries(self):
        ...
        from apps.crm.middleware import TenantContext, set_tenant_context, get_current_tenant_id, clear_tenant_context

        set_tenant_context(TenantContext(
            tenant_id="test-mongo-tenant", tenant_name="Test", country_code="LT",
