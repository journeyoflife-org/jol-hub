...
class VaultClient:
    ...
    def __init__(
        ...
        self.vault_addr = vault_addr or os.environ.get(
            "VAULT_ADDR", "https://vault.jol-hub.eu"
        )
        ...
        try:
            ...
            response = self._session.post(
                ...
                json={
                    ...
                    or f"jol-hub-{os.environ.get('ENVIRONMENT', 'production')}",
    ...
    def _ensure_valid_token(self):
        ...
        if self._token_expiry and datetime.utcnow() > self._token_expiry - timedelta(
            minutes=5
        ):
    ...
    def set_secret(
        ...
        try:
            ...
            logger.error(
                f"Failed to set secret: {response.status_code} - {response.text}"
            )
            return False
