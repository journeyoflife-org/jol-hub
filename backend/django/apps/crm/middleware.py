...
class TenantContextMiddleware:
    ...
    def _extract_tenant_context(self, request: HttpRequest) -> Optional[TenantContext]:
        ...
        request_id = request.headers.get(
            self.REQUEST_ID_HEADER, self._generate_request_id()
        )
        ...
        try:
            ...
            if org:
                info = {
                    ...
                    "data_residency_region": self._get_data_residency_region(
                        org.country
                    ),
...
class TenantDataAccessValidator:
    ...
    def validate_ownership(obj, user) -> bool:
        ...
        obj_owner = getattr(obj, "created_by_id", None) or getattr(
            obj, "owner_id", None
        )
