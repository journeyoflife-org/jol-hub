...
class TenantIsolationVerifier:
    ...
    def _verify_database_isolation(self):
        ...
        self.results.append(self._check_database_row_level_security())
        self.results.append(self._check_organization_foreign_keys())
        self.results.append(self._check_tenant_index_coverage())
        ...
        try:
            ...
            for model_path in self.TENANT_SCOPED_MODELS:
                try:
                    ...
                    has_org = (
                        hasattr(model, "organization")
                        or hasattr(model, "organization_id")
                        or "organization" in [f.name for f in model._meta.fields]
                    )
            ...
            if not missing_indexes:
                return VerificationResult(
                    ...
                    details={
                        ...
                        "database_vendor": self._get_database_vendor(),
                    },
                )
            else:
                return VerificationResult(
    ...
    def _verify_model_organization_fields(self):
        ...
        self.results.append(self._check_model_tenant_validation())
            ...
            for model in apps.get_models():
                ...
                if hasattr(model, "organization_id"):
                    ...
                    # Check for tenant validation in save method source
                        ...
                        source = (
                            model.save.__source__
                            if hasattr(model.save, "__source__")
                            else ""
                        )
                        ...
                        try:
                            ...
                            if (
                                "_validate_tenant_context" in save_source
                                or "tenant" in save_source.lower()
                            ):
                                has_validation = True
    ...
    def _verify_queryset_filtering(self):
        ...
        self.results.append(self._check_viewset_tenant_filtering())
        self.results.append(self._check_queryset_filter_consistency())
    ...
    def _verify_context_isolation(self):
        ...
        self.results.append(self._check_thread_local_isolation())
        self.results.append(self._check_context_cleanup())
    ...
    def _verify_cache_isolation(self):
        ...
        self.results.append(self._check_cache_key_prefixing())
    ...
    def _verify_api_isolation(self):
        ...
        self.results.append(self._check_cross_tenant_decorator())
        self.results.append(self._check_api_response_filtering())
    ...
    def _check_api_response_filtering(self) -> VerificationResult:
        ...
        try:
            ...
            has_queryset_filter = (
                "filter" in source.lower() and "organization" in source.lower()
            )
