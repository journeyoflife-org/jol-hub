...
class ComplianceAuditLogger:
    ...
    def log_create(
        ...
        entry = AuditEntry.objects.create(
            ...
            or getattr(instance, "organization_id", None),
    ...
    def log_update(
        ...
        special_changes = [
            fc for fc in field_changes if fc.field_name in self.SPECIAL_CATEGORY_FIELDS
        ]
        if special_changes:
        ...
        pii_changes = [fc for fc in field_changes if fc.field_name in self.PII_FIELDS]
        if pii_changes:
        ...
        log_details.update(
            {
                ...
                "data_classification": getattr(
                    instance, "data_classification", "internal"
                ),
            }
        )
    ...
    def log_consent_change(
        ...
        operation = (
            "consent_granted" if new_status == "granted" else "consent_withdrawn"
        )
