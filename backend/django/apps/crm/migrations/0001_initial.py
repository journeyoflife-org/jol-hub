...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        help_text="Data deletion suspended due to legal requirements",
                    ),
                ),
                (
                    "legal_hold_reason",
                    models.TextField(blank=True, verbose_name="legal hold reason"),
                ),
                (
                    "legal_hold_until",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="legal hold until"
                    ),
                ),
                # Record integrity
                (
                ...
                (
                    ...
                    models.CharField(
                        ...
                        help_text="Hash chain for audit integrity",
                    ),
                ),
                # Consent tracking
                (
                ...
                (
                    "consent_granted_at",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="consent granted at"
                    ),
                ),
                (
                    "consent_withdrawn_at",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="consent withdrawn at"
                    ),
                ),
                (
                    "consent_version",
                    models.CharField(
                        default="1.0", max_length=32, verbose_name="consent version"
                    ),
                ),
                # Bitrix24 sync
                (
                    ...
                    models.CharField(
                        ...
                        db_index=True,
                        max_length=64,
                        verbose_name="Bitrix24 ID",
                    ),
                ),
                (
                    "bitrix24_synced_at",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Bitrix24 synced at"
                    ),
                ),
                (
                ...
                (
                    "address_postal_code",
                    models.CharField(
                        blank=True, max_length=16, verbose_name="postal code"
                    ),
                ),
                (
                    "address_country",
                ...
                (
                    "place_of_birth",
                    models.CharField(
                        blank=True, max_length=128, verbose_name="place of birth"
                    ),
                ),
                ...
                (
                    ...
                    models.DateField(
                        blank=True, null=True, verbose_name="parish registration date"
                    ),
                ),
                # Sacramental records
                (
                ...
                (
                    "baptism_place",
                    models.CharField(
                        blank=True, max_length=255, verbose_name="baptism place"
                    ),
                ),
                (
                    "first_communion_date",
                    models.DateField(
                        blank=True, null=True, verbose_name="first communion date"
                    ),
                ),
                (
                    "confirmation_date",
                ...
                (
                    "marriage_date",
                    models.DateField(
                        blank=True, null=True, verbose_name="marriage date"
                    ),
                ),
                (
                    "marriage_place",
                    models.CharField(
                        blank=True, max_length=255, verbose_name="marriage place"
                    ),
                ),
                ...
                (
                    "spouse_name",
                    models.CharField(
                        blank=True, max_length=255, verbose_name="spouse name"
                    ),
                ),
                (
                    "father_name",
                ...
                (
                    "mother_name",
                    models.CharField(
                        blank=True, max_length=255, verbose_name="mother's name"
                    ),
                ),
                # Internal tracking
                (
                ...
                (
                    "is_deceased",
                    models.BooleanField(default=False, verbose_name="is deceased"),
                ),
                (
                    "date_of_death",
                    models.DateField(
        ...
        migrations.AddIndex(
            model_name="contact",
            index=models.Index(
                fields=["organization", "data_classification"],
        ...
        migrations.AddIndex(
            model_name="contact",
            index=models.Index(
                fields=["organization", "legal_hold"],
        ...
        migrations.AddIndex(
            model_name="contact",
            index=models.Index(
                fields=["organization", "bitrix24_sync_status"],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="idx_contact_organization_last_name_first_name",
            ),
        ),
        migrations.AddIndex(
            model_name="contact",
            index=models.Index(
                fields=["organization", "email"], name="idx_contact_organization_email"
            ),
        ),
        migrations.AddIndex(
            model_name="contact",
            index=models.Index(
                fields=["organization", "envelope_number"],
                name="idx_contact_organization_envelope_number",
            ),
        ),
        migrations.AddIndex(
            model_name="contact",
            index=models.Index(
                fields=["organization", "is_deceased"],
                name="idx_contact_organization_is_deceased",
            ),
        ),
        # Contact constraints
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "legal_hold",
                    models.BooleanField(
                        db_index=True, default=False, verbose_name="legal hold"
                    ),
                ),
                (
                    "legal_hold_reason",
                ...
                (
                    "record_hash",
                    models.CharField(
                        blank=True, max_length=64, verbose_name="record hash"
                    ),
                ),
                (
                    "previous_hash",
                    models.CharField(
                        blank=True, max_length=64, verbose_name="previous hash"
                    ),
                ),
                # Consent tracking
                (
                ...
                (
                    "transaction_id",
                    models.CharField(
                        blank=True, max_length=128, verbose_name="transaction ID"
                    ),
                ),
                (
                ...
                (
                    "is_tax_deductible",
                    models.BooleanField(
                        default=False, verbose_name="is tax deductible"
                    ),
                ),
                (
                    "receipt_sent",
                ...
                (
                    "mass_intention_for",
                    models.CharField(
                        blank=True, max_length=255, verbose_name="mass intention for"
                    ),
                ),
                (
                    "mass_date",
                    models.DateField(blank=True, null=True, verbose_name="mass date"),
                ),
                # Contract
                (
                    "contract_start_date",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True, null=True, verbose_name="contract duration (months)"
                    ),
                ),
                # Notes
                (
        ...
        migrations.AddIndex(
            model_name="deal",
            index=models.Index(
                fields=["organization", "deal_type", "stage"],
                name="idx_deal_organization_deal_type_stage",
            ),
        ),
        migrations.AddIndex(
            model_name="deal",
            index=models.Index(
                fields=["organization", "contact"], name="idx_deal_organization_contact"
            ),
        ),
        migrations.AddIndex(
            model_name="deal",
            index=models.Index(
                ...
                name="idx_deal_organization_created_at",
            ),
        ),
        migrations.AddIndex(
            model_name="deal",
            index=models.Index(
                fields=["organization", "payment_processed_at"],
                name="idx_deal_organization_payment_processed_at",
            ),
        ),
        # AuditEntry Model
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "operation",
                    models.CharField(max_length=64, verbose_name="operation"),
                ),
                (
                    "entity_type",
                    models.CharField(
                        db_index=True, max_length=64, verbose_name="entity type"
                    ),
                ),
                (
                    "entity_id",
                ...
                (
                    ...
                    models.GenericIPAddressField(
                        blank=True, null=True, verbose_name="actor IP"
                    ),
                ),
                (
                    "actor_user_agent",
                ...
                (
                    "entry_hash",
                    models.CharField(
                        blank=True, max_length=64, verbose_name="entry hash"
                    ),
                ),
                (
                    "previous_hash",
                ...
                (
                    "sequence_number",
                    models.BigIntegerField(default=0, verbose_name="sequence number"),
                ),
                # Compliance metadata
                (
                    "gdpr_basis",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=10, verbose_name="retention period (years)"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="idx_auditentry_organization_event_type_created_at",
            ),
        ),
        migrations.AddIndex(
            model_name="auditentry",
            index=models.Index(
                ...
                name="idx_auditentry_organization_entity_type_entity_id",
            ),
        ),
        migrations.AddIndex(
            model_name="auditentry",
            index=models.Index(
                fields=["sequence_number"], name="idx_auditentry_sequence_number"
            ),
        ),
        migrations.AddIndex(
            model_name="auditentry",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="idx_datasubjectrequest_organization_status_due_date",
            ),
        ),
        migrations.AddIndex(
            model_name="datasubjectrequest",
            index=models.Index(
                ...
                name="idx_datasubjectrequest_request_type_status",
            ),
        ),
    ]
